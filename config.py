...
#Server Joiner
useTokenJoin = True
inviteLink = '' # Only the last 6 digits of the invite link https://discord.gg/XXXXXX | Unless you are using ema
...
#DM Spam
DiscordServer = '1243491228293664828' # Server ID (https://i.imgur.com/m06TSEx.png this one)
ScanAllServers = False # (True or False) Instead of using a server ID this will scan all of the users joined ser
...
#Picture spam
DirPictures = 'C:\Users\jalen\Pictures\Discord Photos' # Picture(s) location, end directory with a double slash.
